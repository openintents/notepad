...
public class ConfigureStickyNotesWidget extends ListActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.stickynote_configure);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		views = new RemoteViews(this.getPackageName(),
				R.layout.stickynote_widget);
		views.setTextViewText(R.id.textViewStickyNote, str);
		...
		views.setOnClickPendingIntent(R.id.textViewStickyNote, pendingIntent);
