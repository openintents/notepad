...
public final class ProviderIntents {
	 ...
	 * 
	 * <p>The extra contains a long[] which contains the row IDs of all rows
	 * affected by the where clause. 
	 * It contains NULL if all rows specified by the URI are affected.</p>
	 * 
	 * <p>Constant Value: "org.openintents.extra.AFFECTED_ROWS"</p>
	 */
